...
*Table 2. The six instrument files behind the essbutterfly.mcstas.org/2026 comparisons.*
...
- Benchmarking website for the McStas ESS_butterfly component – essbutterfly.mcstas.org

- 2026 per-beamport comparison plots – essbutterfly.mcstas.org/2026

- Using MCPL as source term in McStas (ESS Confluence) – confluence.ess.eu/spaces/MCSTAS/pages/217715439

- Example instrument (ESS_butterfly + MCPL input, TCS coordinates) – github.com/mccode-dev/McCode, mcstas-comps/examples/ESS/ESS_butterfly_MCPL_test

- MCPL format and tools – mctools.github.io/mcpl

- Instrument files behind §3: ESS_MCPL_generate_filtered.instr, ESS_butterfly_Guide_curved_test.instr, ESS_butterfly_MCPL_test.instr, ESS_butterfly_MCPL_filtered_test.instr, ESS_butterfly_MCPL_filtered_rotated_test.instr, ESS_butterfly_KDSource_test.instr (P. Willendrup, DMSC/DRAM and DTU Physics).
